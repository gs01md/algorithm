 ...
 * 手机号码
 */
#define ColorfulWoodRegex_mobile @"^1[3|4|5|6|7|8|9][0-9]\\d{8}$"

/**
 * 18位身份证
 */
#define ColorfulWoodRegex_idCard @"(^[0-9]{15}$)|([0-9]{17}([0-9]|X)$)"

/**
 * 00.00 ~99.99
 */
#define ColorfulWoodRegex_99_99 @"([0-9]{0,2})(\\.[0-9]{0,2})?"
